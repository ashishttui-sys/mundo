...
Java_com_bgmi_utils_Downtwo_Version(JNIEnv *env, jclass clazz) {
    ...
    const char *versionUrl = (oxorany("https://github.com/kyoe8698-del/Tap5ap/releases/download/Taptapa/version.txt"));
...
Java_com_bgmi_utils_Downtwo_Link(JNIEnv *env, jclass clazz) {
    ...
    const char *downloadUrl = (oxorany("https://github.com/kyoe8698-del/Tap5ap/releases/download/Taptapa/version.txt")); //Last Mai Apka Zip Name
